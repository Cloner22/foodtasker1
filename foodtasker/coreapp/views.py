...
from coreapp.forms import Meal,  RestaurantForm , UserForm,AccountForm , MealForm 
from django.contrib.auth import authenticate , login
from django.contrib.auth.models import User 
from coreapp.models import Order ,Driver ,Meal
